...
const Projects = () => {
  return (
    <div className="px-20 pt-20 lg:px-32">
        ...
        {projects.map((project) => (
          <div key={project.id}>
            <a href={project.visit} target="_blank" rel="noopener noreferrer">
              <div className="max-w-sm transform overflow-hidden rounded bg-[#1C1C1C] shadow-lg transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-105">
                <img
                  className="w-full"
                  src={project.image}
                  alt={project.title}
